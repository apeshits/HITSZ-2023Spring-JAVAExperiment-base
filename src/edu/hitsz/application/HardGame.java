...
public class HardGame extends Game{
    public HardGame(int mode) {
        super(mode);
    }

    @Override
    public List<AbstractAircraft> createBossAircraft(List<AbstractAircraft> enemyAircrafts, int round) {
