...
public class ImageManager {
    ...
    public static BufferedImage PROP_BOSS_ENEMY;
    ...
    static {
        try {
            ...
            PROP_BOSS_ENEMY = ImageIO.read(new FileInputStream("src/images/boss.png"));
            ...
            CLASSNAME_IMAGE_MAP.put(BossEnemy.class.getName(), PROP_BOSS_ENEMY);
